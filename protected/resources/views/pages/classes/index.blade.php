   ...
   <div class="row tile_count push-margin-down" id="app">
         <div class="">
             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                  <button type="button" class="btn btn-info btn-sm pull-right" data-toggle="modal" data-target="#add-new-class">Add New</button>
                 <div class="x_content">
               ...
               <div class="modal-content">
                 ...
                 <div class="modal-body">
                    <form class="" method="POST" action="{{ route('register') }}">
                        {{ csrf_field() }}
                        @include('pages.classes.add-class-form')
                    </form>
                 </div>
